        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-gray-700 mb-8">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Forecast Period</label>
                <select 
                  value={forecastDays}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-gray-700">
              ...
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-1">2,340 kWh</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm">Expected Peak Production</p>
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">Tomorrow at 2:30 PM</p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-gray-700">
              ...
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-1">18,450 kWh</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm">7-Day Total Forecast</p>
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">+15% vs last week</p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-gray-700">
              ...
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-1">Thursday</h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            {/* 7-Day Forecast */}
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-gray-700">
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-6">7-Day Energy Forecast</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-7 gap-4">
              {forecastData.map((day, index) => (
                <div key={index} className="text-center p-4 rounded-lg bg-gray-50 dark:bg-gray-700/50 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200">
                  ...
                  <div className="text-lg font-bold text-gray-900 dark:text-white mb-1">{day.temp}°C</div>
            ...
            <div className="bg-gradient-to-br from-emerald-50 to-blue-50 dark:from-emerald-900/20 dark:to-blue-900/20 rounded-xl p-8 border border-emerald-100 dark:border-emerald-800/30">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <p className="text-gray-700 dark:text-gray-300">Optimal solar production expected Monday-Tuesday with clear skies and 26°C temperatures.</p>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
                  <p className="text-gray-700 dark:text-gray-300">Wind energy will compensate for reduced solar output during Thursday's rain event.</p>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-orange-500 rounded-full mt-2 flex-shrink-0"></div>
                  <p className="text-gray-700 dark:text-gray-300">Weekend shows excellent conditions for both energy sources with 95% confidence.</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-xl p-8 border border-blue-100 dark:border-blue-800/30">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <p className="text-gray-700 dark:text-gray-300">Schedule maintenance for Wednesday evening to minimize impact during low production period.</p>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-purple-500 rounded-full mt-2 flex-shrink-0"></div>
                  <p className="text-gray-700 dark:text-gray-300">Increase battery storage capacity before Thursday to capture excess wind energy.</p>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                  <p className="text-gray-700 dark:text-gray-300">Consider grid energy purchase on Thursday afternoon to meet demand shortfall.</p>
                </div>
              </div>
            </div>
          </div>
